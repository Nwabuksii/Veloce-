  ...
  return (
    <div className="page-wrap">
      <div className="app-container">
        ...
        {actionMessage && <p style={{ color: "#1b7e4a", marginTop: "1rem" }}>{actionMessage}</p>}
        {!loading && !error && scribes.length === 0 && (
          <p style={{ color: "#5e7188", marginTop: "1rem" }}>No active scribes right now.</p>
        )}
              ...
              {confirmingId === s.id ? (
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", width: "100%", maxWidth: 360 }}>
                  <textarea
                    ...
                    style={{ padding: "0.5rem", borderRadius: "0.6rem", border: "1px solid #d0dae8", fontFamily: "inherit", fontSize: "0.85rem" }}
                  />
                  <div style={{ display: "flex", gap: "0.6rem", alignItems: "center" }}>
                    <span style={{ fontSize: "0.85rem", color: "#b13e3e" }}>Demote for real?</span>
                    <button
                      className="btn"
