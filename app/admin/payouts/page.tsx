    ...
    <div className="page-wrap">
      <div className="app-container">
        ...
        <div style={{ marginTop: "1.5rem" }}>
          <h2>
            <i className="fas fa-money-bill-wave" style={{ color: "#2a7de1" }}></i> Withdrawal requests
          </h2>
          ...
          {!loading && !error && payouts.length === 0 && (
            <p style={{ marginTop: "1rem", color: "#5e7188" }}>No withdrawal requests waiting on you.</p>
          )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem", marginTop: "1rem" }}>
            {payouts.map((p) => (
              <div
                ...
                style={{
                  background: "white",
                  border: p.status === "PROCESSING" ? "2px solid #2a7de1" : "1px solid #e1e8f0",
                  borderRadius: "1rem",
                  padding: "1rem",
                  display: "flex",
