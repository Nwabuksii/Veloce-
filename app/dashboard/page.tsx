    ...
    <div className="page-wrap">
      <div className="app-container">
        ...
        <div style={{ marginTop: "1.5rem" }}>
          <h2>
            <i className="fas fa-layer-group" style={{ color: "#2a7de1" }}></i> Course blocks
          </h2>
          ...
          <div style={{ display: "flex", gap: "0.8rem", margin: "1rem 0", flexWrap: "wrap" }}>
            <div style={{ position: "relative", flex: "1 1 260px" }}>
              <i
                ...
                style={{ position: "absolute", left: "0.9rem", top: "50%", transform: "translateY(-50%)", color: "#9aa8ba" }}
              ></i>
              <input
                value={search}
          ...
          {loading && <p style={{ marginTop: "1rem", color: "#5e7188" }}>Loading blocks...</p>}
          {error && <div className="auth-error" style={{ marginTop: "1rem" }}>{error}</div>}

          {!loading && !error && blocks.length === 0 && (
            <p style={{ marginTop: "1rem", color: "#5e7188" }}>
              {search || courseFilter ? "No blocks match your search." : "No blocks published yet — check back soon."}
            </p>
          )}
            ...
            {blocks.map((block) => (
              <div key={block.id} className={`block-card ${block.unlocked ? "unlocked" : "locked"}`}>
                ...
                {block.topics.length > 0 && (
                  <ul style={{ fontSize: "0.8rem", color: "#5e7188", margin: "0.4rem 0 0.8rem", paddingLeft: "1.1rem" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  {block.discountedPrice != null ? (
                    <span>
                      <span className="price-tag" style={{ textDecoration: "line-through", color: "#9aa8ba", marginRight: "0.4rem" }}>
                        ₦{block.price.toLocaleString()}
                      </span>
                      <span className="price-tag" style={{ color: "#1b7e4a" }}>
                  ...
                  {block.liveNoteCount > 1 ? (
                    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                      {block.unlocked && (
                        <span style={{ color: "#1b7e4a", fontSize: "0.75rem" }}>
                    ...
                    <span style={{ color: "#1b7e4a", fontWeight: 500 }}>
        ...
        {pickerBlock && (
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "0.8rem", color: "#5e7188", marginTop: "0.3rem" }}>
              ...
              {pickerLoading && <p style={{ marginTop: "1rem", color: "#5e7188" }}>Loading versions...</p>}
              ...
              {(() => {
                ...
                if (!pickerLoading && filtered.length === 0) {
                  return (
                    <p style={{ marginTop: "1rem", color: "#5e7188", fontSize: "0.85rem" }}>
                    ...
                    {filtered.map((n) => (
                      ...
                      >
                        <div>
                          ...
                          <div style={{ fontSize: "0.78rem", color: "#5e7188", marginTop: "0.2rem" }}>
                            {n.trustLabel} ·{" "}
                        ...
                        {n.owned ? (
                          <span style={{ color: "#1b7e4a", fontWeight: 500, fontSize: "0.85rem", whiteSpace: "nowrap" }}>
