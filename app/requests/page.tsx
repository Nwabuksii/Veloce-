    ...
    <div className="page-wrap">
      <div className="app-container">
        ...
        <div style={{ marginTop: "1.5rem", maxWidth: 480 }}>
          <h2>
            <i className="fas fa-hand-point-up" style={{ color: "#2a7de1" }}></i> What do you need?
          </h2>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem", marginTop: "1rem" }}>
            ...
            {message && <p style={{ color: "#1b7e4a" }}>{message}</p>}
        ...
        <div style={{ marginTop: "2rem" }}>
          <h2>
            <i className="fas fa-fire" style={{ color: "#2a7de1" }}></i> Open requests
          </h2>
          {loadingFeed && <p style={{ color: "#5e7188", marginTop: "0.6rem" }}>Loading...</p>}
            ...
            {requests.map((r) => (
              ...
              >
                ...
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontWeight: 600, color: "#2a7de1" }}>{r.voteCount} want this</div>
                  {r.requestedByMe && <div style={{ fontSize: "0.75rem", color: "#5e7188" }}>You requested this</div>}
                </div>
              </div>
            ))}
          </div>
