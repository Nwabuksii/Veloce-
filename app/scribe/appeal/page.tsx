    ...
    <div className="page-wrap">
      <div className="app-container" style={{ maxWidth: 560 }}>
        ...
        {!loading && !error && !eligible && (
          <p style={{ color: "#5e7188", marginTop: "1.5rem" }}>
            ...
            <button
              ...
              style={{ background: "none", border: "none", padding: 0, color: "#2a7de1", cursor: "pointer", textDecoration: "underline" }}
            >
        ...
        {!loading && !error && eligible && appeal && (
          <div style={{ marginTop: "1.5rem" }}>
            ...
            <div style={{ marginTop: "1.2rem", background: "white", border: "1px solid #e1e8f0", borderRadius: "1rem", padding: "1.2rem" }}>
              <div style={{ fontSize: "0.8rem", color: "#5e7188", marginBottom: "0.4rem" }}>Your appeal:</div>
              <p style={{ fontSize: "0.9rem", color: "#1a2b3c", whiteSpace: "pre-wrap" }}>&ldquo;{appeal.reason}&rdquo;</p>
        ...
        {showForm && (
          <div style={{ marginTop: "1.5rem" }}>
            <h2>
              <i className="fas fa-undo" style={{ color: "#2a7de1" }}></i> Tell us why you should be reinstated
            </h2>
